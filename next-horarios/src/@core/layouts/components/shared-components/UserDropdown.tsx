...
const UserDropdown = () => {
  ...
  useEffect(() => {
    ...
    name_user_logueado = sessionStorage.getItem("name_user_logueado");
    setuserLogueado(name_user_logueado);
        ...
        <Box sx={{ pt: 2, pb: 3, px: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', marginLeft: 3, alignItems: 'flex-start', flexDirection: 'column' }}>
              <Typography sx={{ fontWeight: 600 }}>{userLogueado}</Typography>
