      ...
      try {
        ...
        valuesPlanificationData.groupsAndAgents.map((GROUPAGENT) => {
          ...
          for (let index = 1; index < 8; index++) {
            ...
            setValuesPlanificationData({...valuesPlanificationData , [GROUPAGENT.id+'_shift_'+index]: shift_selected});
  ...
  return (
    ...
    <CustomSnackbar
      ...
      <Grid container spacing={6}>
        ...
        <Card>
          <CardContent>
            <Button component='a' variant="outlined" onClick={limpiarTodosTurnos} sx={{ px: 5.5 }}>
              Limpiar Todo
            </Button> 
            <br/>
            <br/>
