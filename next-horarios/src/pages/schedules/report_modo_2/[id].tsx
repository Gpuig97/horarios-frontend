...
const MUITable = ({ ColorHeader, groupsAndAgents=[], unavailableDateAgents=[], vacationAgents = [], scheduleDayStandbies= [], scheduleDayLeaders=[], day1_agents = [], day2_agents = [], day3_agents = [], day4_agents = [], day5_agents = [], day6_agents = [], day7_agents = [], schedule, scheduleDayDescansan1 = [], scheduleDayRowDescansan=[], scheduleDayDescansan2 = [], scheduleDayDescansan3 = [], scheduleDayDescansan4 = [], scheduleDayDescansan5 = [], scheduleDayDescansan6 = [], scheduleDayDescansan7 = [], scheduleDayRow = [], tableDescansanHtml= [], scheduleDayTurn1 = [], scheduleDayTurn2 = [], scheduleDayTurn3 = [], scheduleDayTurn4 = [], scheduleDayTurn5 = [], scheduleDayTurn6 = [], scheduleDayTurn7 = [], }: Props) => {
  ...
  const exportToExcel = async () => {
    ...
    try {
      for (let index = 0; index < groupsAndAgents.length; index++) {
        for (let index2 = 0; index2 < alphabet.length; index2++) {
          const letter = alphabet[index2];
          let color_celda = "#ffffff";
          switch (index2) {
            case 3:
              color_celda = groupsAndAgents[index].color_1;
              break;
            case 4:
              color_celda = groupsAndAgents[index].color_2;
              break;
            case 5:
              color_celda = groupsAndAgents[index].color_3;
              break;
            case 6:
              color_celda = groupsAndAgents[index].color_4;
              break;
            case 7:
              color_celda = groupsAndAgents[index].color_5;
              break;
            case 8:
              color_celda = groupsAndAgents[index].color_6;
              break;
            case 9:
              color_celda = groupsAndAgents[index].color_7;
              break;
  ...
  const handleChange = ( name_field: keyof Element,name_input: keyof Element) => (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push("/schedules/report_modo_2/"+router.query.id);
      }, 1000);
    } catch (error) {
        ...
        <Grid container spacing={5}>
          ...
          <TableContainer sx={{ maxHeight: 750 }} id="sheetjs">
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell colSpan={3} style={{backgroundColor: '#C0504D', color: '#ffffff'}}>Agente</TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_1, color: ColorHeader.color_text_fecha_1}}><b>LUNES</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_2, color: ColorHeader.color_text_fecha_2}}><b>MARTES</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_3, color: ColorHeader.color_text_fecha_3}}><b>MIERCOLES</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_4, color: ColorHeader.color_text_fecha_4}}><b>JUEVES</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_5, color: ColorHeader.color_text_fecha_5}}><b>VIERNES</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_6, color: ColorHeader.color_text_fecha_6}}><b>SÁBADO</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_7, color: ColorHeader.color_text_fecha_7}}><b>DOMINGO</b></TableCell>
                </TableRow>
                <TableRow>
                  <TableCell colSpan={3} style={{backgroundColor: '#C0504D', color: '#ffffff'}}>.</TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_1, color: ColorHeader.color_text_fecha_1}}><b>F. {schedule.date_day_1}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_2, color: ColorHeader.color_text_fecha_2}}><b>F. {schedule.date_day_2}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_3, color: ColorHeader.color_text_fecha_3}}><b>F. {schedule.date_day_3}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_4, color: ColorHeader.color_text_fecha_4}}><b>F. {schedule.date_day_4}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_5, color: ColorHeader.color_text_fecha_5}}><b>F. {schedule.date_day_5}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_6, color: ColorHeader.color_text_fecha_6}}><b>F. {schedule.date_day_6}</b></TableCell>
                  <TableCell  style={{backgroundColor: ColorHeader.color_fecha_7, color: ColorHeader.color_text_fecha_7}}><b>F. {schedule.date_day_7}</b></TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {
                  groupsAndAgents.length > 0 ? (
                    groupsAndAgents.map((ROW) => (
                      <TableRow key={ROW.id}> 
                        ...
                        <TableCell style={{backgroundColor: ROW.color_1}}>
                          {ROW.turno_1}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_2}}>
                          {ROW.turno_2}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_3}}>
                          {ROW.turno_3}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_4}}>
                          {ROW.turno_4}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_5}}>
                          {ROW.turno_5}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_6}}>
                          {ROW.turno_6}
                        </TableCell>
                        <TableCell style={{backgroundColor: ROW.color_7}}>
                          {ROW.turno_7}
                        </TableCell>
                      </TableRow>
                    ))
                ...
                <TableRow key={'d2'}>
                  <TableCell colSpan={3}><b>Total Trabajan</b></TableCell>
                  <TableCell >{day1_agents.length}</TableCell>
                  <TableCell >{day2_agents.length}</TableCell>
                  <TableCell >{day3_agents.length}</TableCell>
                  <TableCell >{day4_agents.length}</TableCell>
                  <TableCell >{day5_agents.length}</TableCell>
                  <TableCell >{day6_agents.length}</TableCell>
                  <TableCell >{day7_agents.length}</TableCell>
                </TableRow>
                <TableRow key={'d3'}>
                  <TableCell colSpan={3}><b>Total Descansan</b></TableCell>
                  {
                    scheduleDayDescansan1.length > 0 ? (
                      scheduleDayDescansan1.map((DESCANSAN_ROW_COLUMN) => (
                        <TableCell  key={DESCANSAN_ROW_COLUMN.id}>{DESCANSAN_ROW_COLUMN.total}</TableCell>
                      ))
                    ) : (
...
export const getServerSideProps = async (context) => {
  ...
  const schedule: ScheduleData = {
    id: id,
    view_name_shift: view_name_shift,
    view_name_place: view_name_place,
  ...
  const resScheduleDayTurn = await fetch(StrapiUrl + "schedules-day-turns?populate=%2A&filters[schedule][id]=" + id + "&sort[0]=time_from%3Aasc");
          ...
          scheduleDayTurn1.push(
            {
              id: row.id,
              name: row.attributes.name,
              name_shift: row.attributes.shift.data.attributes.name ? row.attributes.shift.data.attributes.name : '',
