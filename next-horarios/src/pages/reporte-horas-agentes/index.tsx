...
const MUITable = ({ elements = [], AgentsFilterData,site_id_logueado }: Props) => {
  ...
  const exportToExcel = async () => {
    ...
    XLSX.writeFile(wb, "Reporte de Horas Trabajadas.xlsx");
    ...
    try {
      ...
      try{
        values.agents.map(AGENT => {
          ...
          AGENT.horas_complementarias = horas_complementarias;
          AGENT.horas_extras = horas_extras;
          AGENT.horas_nocturnas = horas_nocturnas;
          AGENT.dias_laborados = dias_laborados;
    ...
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <Typography variant='h5'>
          Reporte de Horas Trabajadas Por Agente
        </Typography>
      </Grid>
      <Dialog
          open={openModal}
